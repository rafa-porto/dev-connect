...
export const getFollowers = async (userId: string, limit = 20, offset = 0): Promise<User[]> => {
  try {
    // Query followers by joining follows table with users table
    // Get users who are following the specified userId
